...
public class TJson {
	...
	public TJson (OutputType outputType) {
	...
	static public interface Serializer<T> {
		public void write (TJson json, T object, Class knownType);

		public T read (TJson json, JsonValue jsonData, Class type);
	}
	...
	static abstract public class ReadOnlySerializer<T> implements Serializer<T> {
		...
		abstract public T read (TJson json, JsonValue jsonData, Class type);
	}

	static public interface Serializable {
		public void write (TJson json);

		public void read (TJson json, JsonValue jsonData);
	}
}
