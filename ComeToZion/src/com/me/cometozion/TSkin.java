...
import com.me.cometozion.TJson.ReadOnlySerializer;
 ...
 * be looked up by name and type. Resources can be described in JSON. TSkin provides useful conversions, such as allowing access to
 ...
 * <p>
 * See the <a href="https://code.google.com/p/libgdx/wiki/TSkin">documentation</a> for more.
 * @author Nathan Sweet */
public class TSkin extends Skin {
	...
	public TSkin (FileHandle skinFile) {
	...
	public TSkin (FileHandle skinFile, TextureAtlas atlas) {
		this.atlas = atlas;
		addRegions(atlas);
		load(skinFile);
	}
	 ...
	 * disposed. */
	public TSkin (TextureAtlas atlas) {
		this.atlas = atlas;
		addRegions(atlas);
	}
	...
	public void load (FileHandle skinFile) {
		try {
			getTJsonLoader(skinFile).fromJson(TSkin.class, skinFile);
	...
	protected TJson getTJsonLoader (final FileHandle skinFile) {
		final TSkin skin = this;

		final TJson json = new TJson() {
		...
		json.setSerializer(TSkin.class, new ReadOnlySerializer<TSkin>() {
			public TSkin read (TJson json, JsonValue typeToValueMap, Class ignored) {
			...
			private void readNamedObjects (TJson json, Class type, JsonValue valueMap) {
		...
		json.setSerializer(BitmapFont.class, new ReadOnlySerializer<BitmapFont>() {
			public BitmapFont read (TJson json, JsonValue jsonData, Class type) {
		...
		json.setSerializer(Color.class, new ReadOnlySerializer<Color>() {
			public Color read (TJson json, JsonValue jsonData, Class type) {
		...
		json.setSerializer(TintedDrawable.class, new ReadOnlySerializer() {
			public Object read (TJson json, JsonValue jsonData, Class type) {
